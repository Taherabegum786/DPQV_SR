...
\AddToHook{shipout/foreground}{%
  \put(\strip@pt\paperwidth,0){%
    \makebox(0,0)[tr]{\raisebox{-0.08cm}{\tikz\node[fill=white,rounded corners=3pt,inner sep=1.5pt,opacity=0.95,text opacity=1]
      {\includegraphics[height=0.72cm]{au_logo.png}};\hspace{0.12cm}}}}}
\makeatother
